...
function get_videogal_data(){
    
    $this->db->trans_start();
    $this->db->group_by('eventname');
	$result = $this->db->get('addvideogallery')->result_array();
	$this->db->trans_complete();
	if ($this->db->trans_status() === FALSE)
	{
	   $this->db->trans_rollback(); 
...
function addvideogallery($insertdata){
    
    $this->db->trans_start();
	$result = $this->db->insert('addvideogallery',$insertdata);
	$this->db->trans_complete();
	if ($this->db->trans_status() === FALSE)
	{
	   $this->db->trans_rollback(); 
...
function deletevideogallery($id){
    ...
    $this->db->trans_start();
    $this->db->where('id',$id);
	$result = $this->db->delete('addvideogallery');
	$this->db->trans_complete();
	if ($this->db->trans_status() === FALSE)
	{
	   $this->db->trans_rollback(); 
...
function addparentreviewdata($insertdata){
    
    $this->db->trans_start();
	$result = $this->db->insert('tbl_paranet_review',$insertdata);
	$this->db->trans_complete();
	if ($this->db->trans_status() === FALSE)
	{
	   $this->db->trans_rollback(); 
...
function deleteparentid($id){
	...
	$result = $this->db->delete('tbl_paranet_review');
	$this->db->trans_complete();
	if ($this->db->trans_status() === FALSE)
	{
	   $this->db->trans_rollback(); 
...
function get_tbl_paranet_review(){
    
     $this->db->trans_start();
	$result = $this->db->get('tbl_paranet_review')->result_array();
	$this->db->trans_complete();
	if ($this->db->trans_status() === FALSE)
	{
	   $this->db->trans_rollback(); 
