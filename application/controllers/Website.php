...
function allgallery(){
     $usersession = $this->session->userdata('usersession');
   if(isset($usersession) || !empty($usersession)){
        $eventname  = trim($this->uri->segment(2));
        $segmentId                          = $this->uri->segment(1);
     $data['get_videogal_data'] = $this->regModel->allgallery($eventname); 
          ...
          if(isset($_POST['submit']))
          {
              ...
              if ($this->form_validation->run() == false) {
                  ...
                  if($res==1){
                      ...
                      $data['parents_review_update_list'] = $this->regModel->parents_review_update_list();
                      $data['get_tbl_paranet_review']  = $this->regModel->get_tbl_paranet_review();
                      $data['errorsweet'] = array('error' => "Thank You For Your Details. Our team will contact you soon.!");
                      ...
                      $data['parents_review_update_list'] = $this->regModel->parents_review_update_list();
                      $data['get_tbl_paranet_review']  = $this->regModel->get_tbl_paranet_review();
                      $data['errorsweet'] = array('error' => "Email Or Mobile Already Exist ");
                      $this->load->view('thankyoupage',$data);
                  }
                //   if($res==1){
