...
public function addvideogallerview()
{
   ...
   if($usersession[0]['adminRole']==7  || $usersession[0]['adminRole']==6 || $usersession[0]['adminRole']== 8)
      ...
      if($this->session->userdata('usersession'))
      {
         $data['get_videogal_data'] = $this->regModel->get_videogal_data(); 
         $this->load->view('addvideogallery',$data);
      } else {
        redirect('welcome');
      }
...
function addparentvideo(){
   ...
   if($usersession[0]['adminRole']==7  || $usersession[0]['adminRole']==6 || $usersession[0]['adminRole']== 8)
      ...
      if($this->session->userdata('usersession'))
      {
         $data['get_tbl_paranet_review'] = $this->regModel->get_tbl_paranet_review(); 
         $this->load->view('addparentvideo',$data);
      } else {
        redirect('welcome');
      }
   ...
   if(isset($_POST['submit']))
    {
         ...
         $this->form_validation->set_error_delimiters('<span>', '</span>');
          $this->form_validation->set_rules('vidlink', 'vidlink', 'trim|required');
          ...
          else
          {
              ...
              $insertdata = array('vidlink'=>$vidlink);
              $res       = $this->regModel->addparentreviewdata($insertdata);
                if($res==1){
                  $data['error']        = array('error' => "Data Added Successfully !");
                  $data['get_tbl_paranet_review'] = $this->regModel->get_tbl_paranet_review(); 
                   $this->load->view('addparentvideo',$data);
                    ...
                    $data['error']         = array('error' => "Data not added Successfully !");
                    $data['get_tbl_paranet_review'] = $this->regModel->get_tbl_paranet_review(); 
                    $this->load->view('addparentvideo',$data);
                }
   ...
   if(isset($_POST['submit']))
    {
         ...
         $this->form_validation->set_error_delimiters('<span>', '</span>');
          ...
          {
              $youtubelink         = $this->input->post('youtubelink');
              $eventname           = strtolower($this->input->post('eventname'));
              $insertdata = array('youtubelink'=>$youtubelink,'eventname'=>$eventname);
              $res       = $this->regModel->addvideogallery($insertdata);
                if($res==1){
                  $data['error']        = array('error' => "Data Added Successfully !");
                  $data['get_videogal_data']  = $this->regModel->get_videogal_data(); 
                  $this->load->view('addvideogallery',$data);
   ...
   if(isset($_POST['submit']))
    {
         ...
         $this->form_validation->set_error_delimiters('<span>', '</span>');
          ...
          else
          {
              ...
              $res       = $this->regModel->deletevideogallery($id);
                if($res==1){
                  $data['error']        = array('error' => "Data Deleted Successfully !");
                  $data['get_videogal_data']  = $this->regModel->get_videogal_data(); 
                  $this->load->view('addvideogallery',$data);

                }else{
                    $data['error']         = array('error' => "Data not Deleted Successfully !");
                    $data['get_videogal_data'] = $this->regModel->get_videogal_data(); 
                    $this->load->view('addvideogallery',$data);
                }
     ...
     if(isset($_POST['submit']))
    {
         ...
         $this->form_validation->set_error_delimiters('<span>', '</span>');
          ...
          else
          {
              ...
              $res       = $this->regModel->deleteparentid($id);
                if($res==1){
                  $data['error']        = array('error' => "Data Deleted Successfully !");
                  $data['get_tbl_paranet_review']  = $this->regModel->get_tbl_paranet_review(); 
                  $this->load->view('addparentvideo',$data);
