         ...
         <li class="">
                ...
                <li class="">
                        ...
                        <ul class="sub-menu mm-collapse" aria-expanded="false" >
                            ...
                            <li>
                                <a href="<?php echo base_url('dashboard/addvideogallerview');?>" class="waves-effect">
                                    <i style="font-size:large;" class="typcn typcn-group-outline"></i>
                                    <span>Add Website Video Gallery </span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo base_url('dashboard/addparentvideo');?>" class="waves-effect">
                                    <i style="font-size:large;" class="typcn typcn-group-outline"></i>
                                    <span>Add Parent Video </span>
                                </a>
                            </li>
