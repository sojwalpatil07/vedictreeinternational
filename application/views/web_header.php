<head>
  ...
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-RGHPJVZRXP"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-RGHPJVZRXP');
</script>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-xl-6 col-lg-5 col-md-4">
          <div class="header_social_icon">
            ...
            <a href="https://m.facebook.com/108969485377686/" target="_blank" aria-label="facebook"><i class="fab fa-facebook"></i></a>
            <a href="https://www.instagram.com/vedictreeschool/" target="_blank" aria-label="instagram"><i class="fab fa-instagram"></i></a>
  ...
  <div class="header">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand mr-0" href="<?php echo base_url(); ?>"><img src="<?php echo base_url() ?>assets/website/img/LOGO.png" style="height:90px" alt="Vedic Tree"></a>
        <div class="header-text"><span class="header-one">India's Best</span><span class="header-two">International School  </span></div>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?php echo base_url('course-one'); ?>">Grade 1</a>
                <a class="dropdown-item" href="<?php echo base_url('course-two'); ?>">Grade 2</a>
                <a class="dropdown-item" href="<?php echo base_url('course-three'); ?>">Grade 3</a>
                <a class="dropdown-item" href="<?php echo base_url('course-four'); ?>">Grade 4</a>
                <a class="dropdown-item" href="<?php echo base_url('course-five'); ?>">Grade 5</a>
              </div>
            </li>
            <li class="nav-item">
